### Projeto Sistema de Votação - Aceleração em Java da Trybe

# Requisitos do desafio: Sistema de Votação


Desenvolver um sistema de votação eletrônico. A ideia é que esse sistema permita o cadastro das pessoas candidatas, o cadastro das pessoas eleitoras, a realização do processo de votação e a consulta do resultado tanto parcial quanto final da votação.
